...
(defdomain (openstacks-sequencedstrips-ADL-nocosts ;(test-openstacks
	    :type pure-pddl-domain :source-pddl-domain #.(merge-pathnames "domain-nocosts.pddl" *load-truename*))
